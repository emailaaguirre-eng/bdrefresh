...
export default function WhatWeDoPage() {
  return (
    <>
        ...
        <Container>
          <Reveal>
            ...
            <h2 id="wwd-help" className="font-heading text-3xl font-bold md:text-4xl">
              Teams outgrowing <span className="text-bd-accent">off-the-shelf tools</span>
            </h2>
      ...
      <DarkCtaBand withParticles={false} aria-labelledby="wwd-cta-heading">
        <Reveal>
          <h2
            id="wwd-cta-heading"
            className="font-heading text-[clamp(1.75rem,4vw,2.5rem)] font-extrabold tracking-tight text-white"
          >
            Talk through your <span className="text-bd-accent-lighter">next build</span>
          </h2>
