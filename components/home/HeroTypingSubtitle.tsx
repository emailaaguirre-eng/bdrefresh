...
const FULL_TEXT =
  "We build custom applications, internal tools, and API-powered automations that reduce manual work, connect your systems, and make day-to-day operations easier to manage.";
